 ...
 * Level.java
 * 
 * A class that contains all of the components of a Anti Tower Defence level. 
 * It keeps track of active units, towers, terrain, level info and statistics.
 * 
...
public class Level {
     ...
     * decreased from the players credit.
